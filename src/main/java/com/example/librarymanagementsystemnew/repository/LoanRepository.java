...
public class LoanRepository extends InMemoryRepository<Loan, String> {
    ...
    public LoanRepository() {
        ...
        reservations1.add(new Reservation(UUID.randomUUID().toString(), member1Id, item1Id, new Date()));
        reservations1.add(new Reservation(UUID.randomUUID().toString(), member1Id, item2Id, new Date()));
        ...
        reservations2.add(new Reservation(UUID.randomUUID().toString(), member2Id, item3Id, new Date()));
        ...
        reservations3.add(new Reservation(UUID.randomUUID().toString(), member3Id, item4Id, new Date()));
        reservations3.add(new Reservation(UUID.randomUUID().toString(), member3Id, item5Id, new Date()));
